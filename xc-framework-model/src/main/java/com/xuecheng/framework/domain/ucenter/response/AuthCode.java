...
public enum AuthCode implements ResultCode {
    ...
    AUTH_LOGIN__APPLAYTOKEN_FAIL(false,23007,"申请令牌失败！"),
    AUTH_LOGIN_ERROR(false,23006,"登陆过程出现异常请尝试重新操作！"),
    AUTH_REDIS_ERROR(false,23008,"redis存储令牌失败"),
    AUTH_REDIS__GET_ERROR(false,23008,"redis查询失败"),
    AUTH_LOGINOUT_ERROR(false,23009,"退出失败");
